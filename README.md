                ...
                <div class="container">
                    ...
                    <ul class="about-list list">
                        <li class="list-item">
                            <img 
                             srcset="
                            ./images/doing/doing1@1x.jpg 1x, 
                            ./images/doing/doing1@2x.jpg 2x"  

                            src="./images/doing/doing1@1x.jpg" width="360" alt="computer">
                        </li>
                        <li class="list-item">
                            <img 
                            srcset="
                            ./images/doing/doing2@1x.jpg 1x, 
                            ./images/doing/doing2@2x.jpg 2x" 

                            src="./images/doing/doing2@1x.jpg" width="360" alt="menu">
                        </li>
                        <li class="list-item">
                            <img 
                            srcset="
                            ./images/doing/doing3@1x.jpg 1x, 
                            ./images/doing/doing3@2x.jpg 2x" 

                            src="./images/doing/doing3@1x.jpg" width="360" alt="mobile">
                        </li>
                    </ul>
                </div>
                ...
                <div class="container">
                    ...
                    <ul class="team-list list">
                        <li class="team-card">
                            <img 
                            srcset="
                            ./images/team/img1@1x.jpg 1x, 
                            ./images/team/img1@2x.jpg 2x"                                                        

                            src="./images/team/img1@1x.jpg" width="264" alt=">Mark Guerrero">
                            <div class="info">
                        ...
                        <li class="team-card">
                            <img 
                            srcset="
                            ./images/team/img2@1x.jpg 1x, 
                            ./images/team/img2@2x.jpg 2x"     

                            src="./images/team/img2@1x.jpg" width="264" alt="Tom Ford">
                            <div class="info">
                        ...
                        <li class="team-card">
                            <img 
                            srcset="
                            ./images/team/img3@1x.jpg 1x, 
                            ./images/team/img3@2x.jpg 2x"     
                            
                            src="./images/team/img3@1x.jpg" width="264" alt="Camila Garcia">
                            <div class="info">
                        ...
                        <li class="team-card">
                            <img 
                            srcset="
                            ./images/team/img4@1x.jpg 1x, 
                            ./images/team/img4@2x.jpg 2x"     

                            src="./images/team/img4@1x.jpg" width="264" alt="Daniel Wilson">
                            <div class="info">
        ...
        <div class="menu-container js-menu-container" id="mobile-menu">
            ...
            <ul class="mobile-menu">
                <li class="mobile-item">
                    <a class="mobile-link active-mobile link" href="./index.html">
                        Studio
                    </a>
                </li>
                <li class="mobile-item">
